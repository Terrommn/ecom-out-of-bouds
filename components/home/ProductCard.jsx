...
export function ProductCard({ product }) {
  ...
  return (
    <article className="group flex flex-col rounded-lg border border-[color:var(--oob-border)] bg-[var(--oob-surface)]/40 overflow-hidden transition hover:border-[var(--oob-gold)]/50 hover:shadow-lg hover:shadow-black/20">
      <Link href={href} className="relative aspect-[3/4] block bg-[var(--oob-bg-elevated)] overflow-hidden">
        ...
        {img?.url ? (
          ...
          <div
            ...
            aria-hidden
          >
            <span className="text-[var(--oob-muted)] text-xs uppercase tracking-widest">OOB</span>
          </div>
        )}
      </Link>
