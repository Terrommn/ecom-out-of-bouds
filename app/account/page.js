...
export default function AccountPage() {
  ...
  return (
    <div className="oob-container max-w-lg py-16 md:py-20">
      ...
      <div className="mt-12 border-t border-[color:var(--oob-border)] pt-8 text-sm text-[var(--oob-muted)] space-y-3">
        <p>
          <strong className="text-[var(--oob-cream)]">Login social (Google/Facebook):</strong>{" "}
          requiere configuración en Shopify (Customer Account API, apps o multipass). En el
          repositorio, consulta el archivo <code className="text-[var(--oob-gold)]">docs/CUSTOMER_ACCOUNT.md</code>.
        </p>
      </div>
    </div>
  );
